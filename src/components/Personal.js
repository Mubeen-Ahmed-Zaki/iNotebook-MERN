...
// const Personal = ({ resetProfile, resetPassword }) => {
//   return (
//     <div id="personal-section" className="content-section">
//       <div className="content-header">
//         <h1 className="content-title">Personal</h1>
...
//               </button>
//               <button type="button" className="btn btn-outline" onClick={resetPassword}>
//                 Reset
//               </button>
//             </div>
//           </form>
